      ...
      <div class="container-fluid container-xl position-relative d-flex align-items-center">
        ...
        <nav id="navmenu" class="navmenu">
          <ul>
            ...
            <li><a href="../../Views\backoffice/read-pack.php">Afficher pack</a></li>
            <li><a href="../../Views\backoffice/add-pack.php">Ajouter pack</a></li>
            <li><a href="../../Views\backoffice/update-pack.php">Modifier pack</a></li>
            <li><a href="../../Views\backoffice/delete-pack.php">Supprimer pack</a></li>
